/**
 * Session store + wallet connection layer for the MARA frontend.
 *
 ...
 * Guest: browse-only pass — credits are granted only on real logins.
 */
'use client';
...
let state: SessionState = { user: null, credits: 0, loading: true };
const SERVER_SNAPSHOT: SessionState = { user: null, credits: 0, loading: true };
